ActionView::Helpers::AssetTagHelper rescue require 'action_view/asset_paths' # Might be needed in some testing environments
...
begin
  ActionView::Helpers::AssetTagHelper::JavascriptTagHelpers.register_javascript_expansion :default => ["swfobject"]
